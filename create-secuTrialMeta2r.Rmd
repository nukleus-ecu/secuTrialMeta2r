---
title: "Processing secuTrial Meta Data in R"
author: "Olga Miljukov"
date: "08. May 2023"
knit: litr::render
output: litr::litr_html_document
params:
  package_name: "secuTrialMeta2r" 
  package_parent_dir: "." 
---
...
usethis::create_package(
  ...
  fields = list(
    ...
    Version = "0.0.0.9000",
    Title = "Processing secuTrial Meta Data in R",
    Description = "Reading, Translating into R, Parsing and making use of meta data (on study data exported) from the clinical data management system 'secuTrial'",
    `Authors@R` = person("Olga", "Miljukov", email = "miljukov_o@ukw.de",
                         role = c("aut", "cre", "cph"), comment = c(ORCID = "0000-0003-4790-5918")
      )
  )
)
usethis::use_mit_license(copyright_holder = "O. Miljukov")
```
